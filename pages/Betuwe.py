...
st.image(["data/images/CorrectDecl1.png","data/images/CorrectDecl2.png"], width=350, caption=["Winter image showing correct delineation of bufferstrip and presence of vegetation","Summer image showing correct delineation of bufferstrip and presence of vegetation"])
st.image(["data/images/ProbWrongDecl1.png","data/images/ProbWrongDecl2.png"],width=350, caption=["Winter image showing incorrect delineation of fallow land and no vegetation","Winter image showing incorrect delineation of fallow land and no vegetation"])
